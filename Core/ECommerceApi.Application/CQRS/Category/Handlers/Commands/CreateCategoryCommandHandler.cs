...
namespace ECommerceApi.Application.CQRS.Category.Handlers.Commands
{
    ...
    public class CreateCategoryCommandHandler : IRequestHandler<CreateProductCommandRequest, CreateProductCommandResponse>
    {
        private readonly IProductRepository _productRepository;
        private readonly IMapper _mapper;

        public CreateCategoryCommandHandler(IProductRepository productRepository, IMapper mapper)
        {
